...
var author$project$Header$headerView = A2(
	elm$html$Html$div,
	_List_Nil,
	_List_fromArray(
		[
			...
			_List_fromArray(
				[
					elm$html$Html$text('tabbit')
				]))
		]));
var author$project$Main$SetSheetName = elm$core$Basics$identity;
...
var author$project$Main$view = function (model) {
	return A2(
		...
		_List_fromArray(
			[
				author$project$Header$headerView,
				A2(
				elm$html$Html$h1,
				_List_Nil,
				_List_fromArray(
				...
				_List_fromArray(
					[
						...
						elm$html$Html$Attributes$placeholder('Sheet Name'),
